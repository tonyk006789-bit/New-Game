# Codex assignment | iteration 2 | S3
...
## Objective
Keno + accurate reporting. Implement S3 only. Planning window: Weeks 8-9; report actual effort and blockers.
...
## Acceptance
Approved per-selection rules/paytables; recoverable draws; admin changes excluded from game return.
