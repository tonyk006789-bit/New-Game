# Codex assignment | iteration 2 | S2
...
## Objective
Mobile lobby + first slot. Implement S2 only. Planning window: Weeks 5-7; report actual effort and blockers.
...
## Acceptance
Approved slot math before staked play; one complete admin-to-player flow on both platforms; durable recovery.
