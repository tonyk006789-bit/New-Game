...
const props=defineProps<{game:string;ready:boolean;authenticated:boolean;busy?:boolean;reducedMotion?:boolean}>();
const disabled=computed(()=>!props.ready||props.busy||stage.busy||!!stage.pending||creditPresentation.held!==null);
