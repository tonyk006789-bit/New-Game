...
| Reef Party | Separate experiment: a valid targeted shot has 30% capture probability and 3× return. All eight species have identical financial rules; anatomy, speed and size differ. Invalid/expired/already captured targets are rejected without charging. |
